...
curl $(curl https://covid19.ssi.dk/overvagningsdata/vaccinationstilslutning|rg 'https://files.ssi.dk/covid19/vaccinationstilslutning/status/vaccinationstilslutning-[0-9a-z-]+' -o|head -n1) > vaccinationstilslutning.pdf
